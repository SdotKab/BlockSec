    ...
    <div>
      ...
      <div className="flex flex-col xl:flex-row gap-8 mb-12">
        ...
        <div className="flex flex-col p-4 gap-2 xl:w-2/3">
          <div>
            <p className="mb-3">
              I'm a passionate tech enthusiast with a deep curiosity for emerging technologies, particularly Web3 and AI. My fascination lies in exploring how these innovations are set to revolutionize the digital landscape, especially in the realm of security. I'm particularly interested in how advancements in AI and blockchain technologies will reshape Identity and Access Management (IAM) and privacy in Web3, and how blockchain networks will defend against increasingly sophisticated malicious actors. Additionally, I’m excited about the role AI will play in streamlining the development and security of decentralized applications (dApps), as well as the potential of AI agents to autonomously handle complex tasks in real time. These AI-driven agents could reshape industries, providing both efficiency and new levels of intelligence in systems that once relied heavily on human oversight.
            </p>
            <p className="mb-3">
        ...
        <div className="flex flex-col xl:flex-row gap-8 mb-12">
          <div className="flex flex-col gap-4 justify-center items-center xl:w-1/4 md:flex-row md:flex-wrap md:-mb-px">
            <ul className="flex-row md:flex-row space-y space-y-4 text-sm font-medium">
              <li>
                  <a href="#" className="inline-flex items-center p-4 border-b-2 border-transparent hover:text-green-600 hover:border-green-300">
                      Project 1
                  </a>
              </li>
              <li>
          ...
          <div className="flex flex-col px-16 py-10 gap-2 xl:w-3/4">
            <h3 className="text-md font-bold text-gray-900">Project Title</h3>
